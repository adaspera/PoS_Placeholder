...
const Payment = ({paymentData, order, tip, onPaymentSuccess, isSplitPayment, partialAmount, onPartialPaymentSuccess}) => {
    const options = {
    ...
    return (
        <Elements stripe={stripePromise} options={options}>
            <CheckoutForm paymentData={paymentData} order={order} tip={tip} onPaymentSuccess={onPaymentSuccess}
                          isSplitPayment={isSplitPayment} partialAmount={partialAmount} onPartialPaymentSuccess={onPartialPaymentSuccess}/>
        </Elements>
    );
};
